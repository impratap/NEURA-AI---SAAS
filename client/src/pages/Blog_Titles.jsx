...
function Blog_Titles() {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true)
      const prompt = `Generate a blog title for the keywrd ${input} 
  ...
  return (
    ...
    gap-4 text-slate-700'>
      {/* left col */}
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gary-200'>
        ...
        rounded-d border border-gray-300' placeholder='The future of artificial intelligence is ... ' required />

       <p className='mt-4 text-sm font-medium'>Category</p>

       <div className='mt-3 flex gap-3 flex-wrap sm:max-w-911'>
