  ...
  return (
    ...
    gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gary-200'>
        ...
        rounded-d border border-gray-300 text-gray-600' required />
        ...
        rounded-d border border-gray-300' placeholder='e.g., watch or spoon, Only single object name' required />
